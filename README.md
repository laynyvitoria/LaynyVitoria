<div style="display: flex;">
  ...
  <span style="display: inline-block; width: calc(100% - 200px);">
    ...
    <p style="margin-left:20px; text-align: justify; text-indent: 20px;">
      ...
      Faz parte de mim amar a adaptablidade e autossuficiência dos gatos – fora todos serem extraordinariamente lindos e magnéticos(🤣❤️). Estou sempre tentando melhorar e aprender mais, tanto na tecnologia quanto na vida. Espero que se sinta bem-vindo(a) em ver a minha jornada ao progresso!
    </p>
  </span>
</div>
