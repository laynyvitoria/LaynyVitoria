<div style="display: flex;">
  ...
  <span style="display: inline-block; width: calc(100% - 200px);">
    <p align="right">
      <img src="tenor.gif" width="190" align="right" style="margin-left: 20px; margin-top: 30px; margin-bottom: 10px;">
    </p>
    <p style="margin-left: 20px; margin-right: 20px; text-align: justify-content; text-indent: 20px;">
